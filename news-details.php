          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <p><b>Danh Mục : </b> <a href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><?php echo htmlentities($row['category']);?></a> |
                <b>Chuyên Mục : </b><?php echo htmlentities($row['subcategory']);?> | <b> Đăng lúc: </b><?php echo htmlentities($row['postingdate']);?></p>
                <hr />
...
<input type="text" name="name" class="form-control" placeholder="Vui lòng nhập Tên đầy đủ" required>
</div>

 <div class="form-group">
 <input type="email" name="email" class="form-control" placeholder="Vui lòng nhập email" required>
 </div>
